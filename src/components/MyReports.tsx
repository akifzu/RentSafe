          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white">Move-In Report</h3>
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
                ...
                <span>Submitted on {new Date(selectedReport.submittedAt).toLocaleDateString('en-US', {
                  weekday: 'long',
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
              ...
              <div className="space-y-6">
                {selectedReport.rooms.map((room, index) => (
                  <div key={index} className="border border-gray-200 rounded-xl overflow-hidden">
                    ...
                    <div className="p-5">
                      {room.notes && (
                        <p className="text-gray-600 text-sm mb-4">{room.notes}</p>
                      )}
                      {room.photos.length > 0 ? (
                        ...
                        <p className="text-gray-400 text-sm italic">No photos attached</p>
                      )}
                    </div>
                  </div>
                ))}
